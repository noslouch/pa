...
require.config({
    paths : {
        ...
        'app/views/details/book' : 'app/views/details/book.@@hash',
        'app/views/details/film' : 'app/views/details/film.@@hash',
        'app/views/details/photo' : 'app/views/details/photo.@@hash',
        'app/views/details/project' : 'app/views/details/project.@@hash',
