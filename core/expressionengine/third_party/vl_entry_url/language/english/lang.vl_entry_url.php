...
$lang['intro'] = '<p>Define the URL pattern for the channels that you want to enable. Special values:</p>
				  <ul>
				  	...
				  	<li><strong>{day}</strong> &ndash; Day from entry date</li>
				  </ul><br>';
$lang['channel_heading'] = 'Channel';
$lang['url_heading'] = 'URL Pattern<br><small>Use relative paths. Ex: /work/{url_title}</small>';

/* End of file lang.vl_entry_url.php */
/* Location: /system/expressionengine/third_party/vl_entry_url/language/english/lang.vl_entry_url.php */
